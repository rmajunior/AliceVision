...
namespace aliceVision {
	...
	* Input parameters:
	* @param X	10x2 matrix of 2D distorted measurements (X == [x y]')
	* @param U	10x2 matrix of 2D distorted measurements (U == [u v]')
	*
	* Output parameters:
	* @param F  A list of candidate fundamental matrices solutions
	* @param L  A list of candidate radial disortion solutions (L[i] = [l1 l2]').
	*
